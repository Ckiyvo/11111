...
from .views import upload_files, create_project, get_projects, get_project_files, get_project_list,delete_project,delete_file, get_file_content, process_selected_files
...
urlpatterns = [
    ...
    path('api/process_files/', process_selected_files, name='process_selected_files'), 
]