...
class AudioProcessor:
    def __init__(self, trans_model_path):
        # 加载处理器和模型
        self.processor = WhisperProcessor.from_pretrained(trans_model_path)
        self.trans_model = WhisperForConditionalGeneration.from_pretrained(trans_model_path)
...
if __name__ == "__main__":
    ...
    audio_processor = AudioProcessor(trans_model_path)

    # 读取音频文件
    audio_path = r"F:\a\apaper\project\project\algorithm\test_media\common_voice_zh-CN_40970484.wav"
